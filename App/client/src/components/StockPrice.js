...
const StockPrice = () => {
  ...
  const handlePredict = () => {
    ...
    axios
      .post("http://localhost:5000/stock/predict", {
              ...
              <Card.Body className="p-10 ">
                ...
                <ul className="text-xl mb-6">
                  <li className="mb-4 flex items-start">
                    <span className="mr-3 text-xl text-purple-900 align-middle inline-block w-6">
                      &#8226;
                    </span>
                  ...
                  <li className="mb-4 flex items-start">
                    ...
                    Next, choose a stock symbol you want to predict the price
                    for.
                  </li>
                  <li className="mb-4 flex items-start">
                    <span className="mr-3 text-xl text-purple-900 align-middle inline-block w-6">
